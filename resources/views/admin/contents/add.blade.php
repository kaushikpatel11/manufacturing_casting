            ...
            <div class="card-body">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Size <span class="required">*</span></label>
                                <div class="col-sm-9">
                                    {!! Form::text('size',null,['class' => 'form-control', 'data-required' => true,'placeholder'=>'Enter Size']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Quantity no <span class="required">*</span></label>
                                <div class="col-sm-9">
                                    {!! Form::number('qn_no',null,['class' => 'form-control', 'data-required' => true,'placeholder'=>'Enter Quantity no', 'min'=>0]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
