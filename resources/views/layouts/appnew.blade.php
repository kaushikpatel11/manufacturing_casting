					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +91987654321</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> info@armorfire.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{ asset('client/images/home/logo.png') }}" alt="" width="30%" /></a>
						</div>
...
<main>
	 ...
	 <footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 ARMORFIRE Inc. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a>NKAD</a></span></p>
				</div>
			</div>
		</div>
